...
## A cor do personagem tinge também a pele (cabeça e mãos), como nos bots de antes das roupas.
## Desligado, só o tecido leva a cor.
@export var tint_skin: bool = false
